    ...
    <div>
      ...
      <div className="mt-3 grid gap-3 md:mt-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <Image src={ClockIcon} alt="VecotrIcon" className="size-5 md:size-auto" height={20} width={20} />
            <p className="text-sm text-gray-500 md:text-base">10 phút đọc</p>
          </div>
        </div>

        <div
          className=" flex cursor-pointer items-center gap-4 text-gray-500 transition-transform duration-300 hover:translate-x-2"
